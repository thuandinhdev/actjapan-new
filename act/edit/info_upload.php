...
//広告学生賞名を取得//
$PageTitle = getJustEntryPrizeTitle($prize_id);
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <script
      type="text/javascript"
      src="../../common/js/jquery.textresizer.min.js"
    ></script>
    <script type="text/javascript" src="../../common/js/base.js"></script>
    <script
      type="text/javascript"
      src="../../common/js/video_function2.js"
    ></script>

    <!-- Video API -->
    <script
      type="text/javascript"
      src="../../common/js/api/html5media.min.js"
    ></script>
    <!--[if lt IE 9
  ...
  <body>
      ...
      <div id="innner">
        <div id="header_right">
          ...
          <div id="chg-font-size" class="cf">
            <div id="font-size">
              <img
                src="../../common/images/font-size.gif"
                width="58"
                height="12"
                alt=""
              />
          ...
          <div id="logo">
            <h1>
              <a href="../../index.html"
                ><img
                  src="../../common/images/logo_header.png"
                  width="146"
                  height="45"
                  alt="公益社団法人ACジャパン"
              /></a>
          ...
          <a
            href="../../about_ac/english/about_ac.html"
            id="link_english"
            target="_blank"
            >english</a
          >
          ...
          <ul id="gnav">
            <li id="gnav_about_ac">
              ...
              <ul class="submenu">
                ...
                <li>
                  <a href="../../about_ac/action.html"
                    >ACジャパンの活動のしくみ</a
                  >
                </li>
                <li>
                  <a href="../../about_ac/mebae.html"
                    >ACマスコットめばえちゃん</a
                  >
                </li>
              </ul>
            ...
            <li id="gnav_campaign">
              ...
              <ul class="submenu" id="cp">
                ...
                <li class="odd">
                  <a href="../../campaign/rule.html"
                    >支援キャンペーン実施諸規則</a
                  >
                </li>
                <li class="trouble">
                  <a href="../../campaign/production.html"
                    >プレゼンテーション<br />参加広告会社</a
                  >
                </li>
                <li class="odd">
                  <a href="../../campaign/self_theme.html"
                    >全国キャンペーンテーマ</a
                  >
                </li>
                <li>
                  <a href="../../campaign/self_all/index.html"
                    >全国キャンペーン</a
                  >
                </li>
                <li class="odd"><a href="">広報キャンペーン</a></li>
                <li>
                  <a href="../../campaign/self_area/index.html"
                    >地域キャンペーン</a
                  >
                </li>
                <li class="odd">
                  <a href="../../campaign/support/index.html"
                    >支援キャンペーン</a
                  >
                </li>
                <li class="trouble">
                  <a href="../../campaign/nhk/index.html"
                    >ＡＣジャパン・NHK<br />共同キャンペーン</a
                  >
                </li>
                <li class="odd">
                  <a href="../../campaign/cm/index.html"
                    >ＡＣジャパン広告学生賞</a
                  >
                </li>
                <li><a href="">臨時キャンペーン</a></li>
                <li class="trouble">
                  <a href="../../campaign/search.php"
                    >ＡＣジャパン<br />広告作品アーカイブ</a
                  >
                </li>
                <li>
                  <a href="../../campaign/view/index.html"
                    >広告賞受賞作品一覧</a
                  >
                </li>
                <li>
                  <a href="../../campaign/rental.html"
                    >広告作品の貸出について</a
                  >
                </li>
                <li>
                  <a href="../../campaign/secondary_use.html"
                    >広告作品の二次使用について</a
                  >
                </li>
              </ul>
    ...
    <div id="container">
        ...
        <div id="contents_area" class="cf">
          ...
          <div id="maincontent" class="cf">
            <div id="maincontent-innner" class="cf">
              ...
              <div class="upload_form">
                ...
                <p>
                  <a
                    href="https://www.ad-c.or.jp/campaign/cm/recruit_oubo.html"
                    target="_blank"
                ...
                <div class="name-file">
                  ...
                  <div class="file-code">
                    ...
                    <span class="note"
                      >※応募作品データのファイル名は上記を使用してください。上記以外のファイル名は無効・失格となる場合があります。
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div class="rightmenu">
            <ul class="localnavi">
              ...
              <li class="">
                <a href="../../campaign/nhk/index.html"
                  >ＡＣジャパン・NHK<br /><span style="padding-left: 30px"
                    >共同キャンペーン</span
                  ></a
                >
              </li>
      ...
      <li>CM学生賞の実施</li>
              ...
              <li class="">
                <a href="../../campaign/search.php"
                  >ＡＣジャパン<br /><span style="padding-left: 30px"
                    >広告作品アーカイブ</span
                  ></a
                >
              </li>
